...
@implementation purpleShowView
{
    purpleTextStyle _currentStyle;
...
//    CGContextSetTextMatrix(context, CGAffineTransformIdentity);
    ...
    purpleLayoutModel *model = [[purpleLayoutModel alloc] init];
    model.context = context;
    model.rect = rect;
    model.document = _purpleDocument;
    
    [[purpleLayoutPluginConfigs shareInstance] purpleLayout:model style:_currentStyle];
    
}


//-(void)purpleLayoutForStyle1:(CGContextRef)context Rect:(CGRect)rect
//{
...
//            _currentCTFrameBounds = CGRectMake(0.0, _currentHeight-contentSize.height, self.bounds.size.width, contentSize.height);
...
//            
//            CGMutablePathRef path = CGPathCreateMutable();
//            _currentCTFrameBounds = CGRectMake(5, _currentHeight-contentSize.height-CTBlockLeadingDiff, self.bounds.size.width, contentSize.height);
//            CGPathAddRect(path, NULL, _currentCTFrameBounds);
//
//            CTFrameRef ctFrame = CTFramesetterCreateFrame(ctFramesetter,CFRangeMake(0, 0), path, NULL);
//            
...
//            
//            //右边的矩形框
//            CGRect rightRect = CGRectMake(5, _currentHeight-contentSize.height-2*CTBlockLeadingDiff, self.bounds.size.width-5, contentSize.height+2*CTBlockLeadingDiff);
//            CGContextSetLineWidth(context, 0.0f);
...
//            
//            CGRect imageRect = CGRectMake(0, _currentHeight-80, self.frame.size.width, 80);
